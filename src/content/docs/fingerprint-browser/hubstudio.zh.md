...
使用 **Lumiproxy** 和 **Hubstudio** 简化您的账户管理并保护您的浏览安全。按照本指南配置 Lumiproxy，以实现无缝且匿名的 **Hubstudio** 体验
...
:::
## 步骤 1. 下载 Hubstudio
前往 **[Hubstudio](https://www.hubstudio.com/index.html)** 官网 下载并安装该应用程序。
...
:::info ℹ️
某些版本的 Hubstudio 使用 google.com 作为默认的测试网站。lumiproxy 代理会阻止对 google.com 的访问，因此请确保测试网站不是搜索引擎网站。
:::
...
就这样！您已成功将 lumiproxy 代理集成到 Hubstudio 中，现在可以开始使用了！
