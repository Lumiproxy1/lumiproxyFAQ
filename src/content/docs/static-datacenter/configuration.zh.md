...
- 代理
- [静态数据中心代理](https://www.lumiproxy.com/zh-hans/user/datacenter/pricing/)

![定价](/src/assets/img/Static-data/定价-zh.png)

- [代理设置](https://www.lumiproxy.com/zh-hans/user/datacenter/user-pass-auth/)

## 账密创建

![用户列表](/src/assets/img/Static-data/用户列表-zh.png) 
...
## 提取IP代理
![账密认证](/src/assets/img/Static-data/提取ip-zh.png)
