...
- 代理
- [无限代理](https://www.lumiproxy.com/zh-hans/user/unlimited/pricing/)

- [代理设置](https://www.lumiproxy.com/zh-hans/user/residential/user-pass-auth/)

![代理设置](/src/assets/img/Unlimited/代理设置-zh.png)

## 账密创建

![用户列表](/src/assets/img/Unlimited/用户列表-zh.png) 
...
![添加用户](/src/assets/img/Unlimited/添加用户-zh.png)
...
## 提取IP代理
![账密认证](/src/assets/img/Unlimited/账密提取-zh.png)
...
- 添加[IP 白名单](https://www.lumiproxy.com/zh-hans/user/unlimited/ip-whitelist/)中添加您的服务器出口 IP，即可免账密直连。

:::danger 🚨
不支持添加**中国大陆IP**白名单
:::

![IP白名单](/src/assets/img/Unlimited/ip白名单-zh.png)


## API提取

![API提取](/src/assets/img/Unlimited/api提取-zh.png)
