# Residential Proxies · Configuration
...
* Proxies
* [Residential Proxies](https://www.lumiproxy.com/user/residential/pricing/)
* [Proxy Settings](https://www.lumiproxy.com/user/residential/user-pass-auth/)

![代理设置](/src/assets/img/residential/configuration/代理设置-en.png)
## User Creation
![用户列表](/src/assets/img/residential/configuration/用户列表-en.png) 
...
:::
![添加用户](/src/assets/img/residential/configuration/添加用户-en.png)
...
![账密认证](/src/assets/img/residential/configuration/账密认证-en.png)
### Default Mode
...
* Add your server's outbound IP to the [IP Whitelist](https://www.lumiproxy.com/user/residential/ip-whitelist/) to connect directly without a username and password.

:::danger 🚨
Adding **Mainland China IPs** to the whitelist is not supported.
:::
![IP白名单](/src/assets/img/residential/configuration/ip白名单-en.png)
## API Extraction

![API提取](/src/assets/img/residential/configuration/ip提取-en.png)
### Parameter Description:
