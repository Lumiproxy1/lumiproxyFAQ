# Static Residential Proxies · Configuration
...
* Proxies
* [Static Residential Proxies](https://www.lumiproxy.com/user/static/pricing/)

![定价](/src/assets/img/Static-residential/静态定价-en.png)


* [Proxy Settings](https://www.lumiproxy.com/user/static/user-pass-auth/)

## User Creation

![用户列表](/src/assets/img/Static-residential/用户列表-en.png) 
### Custom Username and Password

:::danger 🚨
The username and password must consist of 6–12 alphanumeric characters (letters and numbers, case-sensitive).
:::
![添加用户](/src/assets/img/Static-residential/用户列表-en.png)
...
## Proxy IP Extraction
![账密认证](/src/assets/img/Static-residential/生成ip-en.png)
### Default Mode
